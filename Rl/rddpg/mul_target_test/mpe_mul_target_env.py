...
# @FileName: mpe_env.py
# @Software: PyCharm
from rddpg.mul_target_test.environment_mul_target import MultiAgentEnv
import rddpg.mpe.scenarios as scenarios
from rddpg.mpe.scenarios.utils import space_n_to_shape_n
