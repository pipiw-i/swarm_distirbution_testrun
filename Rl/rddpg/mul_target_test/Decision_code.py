...
import numpy as np
from rddpg.mul_target_test.boids_policy import boids_policy
from rddpg.mul_target_test.RL_policy import RL_policy
from rddpg.mul_target_test.mpe_mul_target_env import mpe_env
...
if __name__ == '__main__':
    for i in range(2, 3):
        ...
        r_env, r_number_agent, r_load_file, r_need_render = run_mpe(
            load_file='/home/pipiw/桌面/Rl/distribution_policy/run_distribution_e3_syn_para_double_random_6_6_10',
